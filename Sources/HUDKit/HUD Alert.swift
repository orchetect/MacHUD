...
extension HUD {
    ...
    internal class Alert {
        ...
        weak var hudView_VisualEffectView: NSVisualEffectView?
        weak var hudView_CIMotionBlur: CIFilter?
...
extension HUD.Alert {
    ...
    fileprivate func __create() throws {
        try autoreleasepool {
            ...
            hudTextField.preferredMaxLayoutWidth = (nsScreen.visibleFrame.size.width - 50)
                .clamped(to: 1...)
    ...
    fileprivate func __modify(
        ...
        try autoreleasepool {
            ...
            case .center:
                displayBounds.origin
                    .y = (screenMainFrame.size.height - hudTextField.frame.size.height - 40) * 0.5
            case .top:
                displayBounds.origin
                    .y = (screenMainFrame.size.height - hudTextField.frame.size.height - 40 - 150)
            }
